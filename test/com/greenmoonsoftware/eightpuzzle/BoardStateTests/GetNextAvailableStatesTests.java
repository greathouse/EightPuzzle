...
public class GetNextAvailableStatesTests extends TestBase {
  ...
  public void testMiddleLeft() {
    setup8();
    run("1 2 3 0 4 5 6 7 8", 3, new String[]{"0 2 3 1 4 5 6 7 8", "1 2 3 4 0 5 6 7 8", "1 2 3 6 4 5 0 7 8"});
  }
  ...
  public void testMiddleRight() {
    setup8();
    run("1 2 3 4 5 0 6 7 8", 3, new String[]{"1 2 0 4 5 3 6 7 8", "1 2 3 4 0 5 6 7 8", "1 2 3 4 5 8 6 7 0"});
  }
  ...
  public void testBottomCenter() {
    setup8();
    run("1 2 3 4 5 6 7 0 8", 3, new String[]{"1 2 3 4 0 6 7 5 8", "1 2 3 4 5 6 0 7 8", "1 2 3 4 5 6 7 8 0"});
  }
  
  public void testBottomRight() {
    setup8();
    run("1 2 3 4 5 6 7 8 0", 2, new String[]{"1 2 3 4 5 0 7 8 6", "1 2 3 4 5 6 7 0 8"});
  }
}
